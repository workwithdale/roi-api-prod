// ============================================================
// Pro User Questions (v2.3.1 WEEKLY_LOCKED)
// ------------------------------------------------------------
// Updated for: Pro Engine Constants v2.3.1 (SafeMath-Lock Sync)
// • Restored commentary for Q1–Q3, Q5
// • Enhanced Q4–Q7 with SMS, lift, engagement, ROI context
// • Confirmed variable mapping alignment (a,b,g,PlanFee,L,n,d)
// ------------------------------------------------------------
// Version tag helps align constants.ts and questions.ts
// ============================================================

export const REQUIRED_KBS = [
  "Pro Flow Instructions (v2.0.7 Secure+Sync+Patched).md",
  "Pro Flow Helper (v1.3).md",
  "Pro User Questions v2.3.1 (WEEKLY_LOCKED).md", // ✅ updated KB reference
...
export const OPTION_MAP = {
  ...
  L: { 1: 5, 2: 10, 3: 15, 4: 20, 5: 25, 6: 30 }, // ✅ corrected range to match Q5
  n: { 1: 10, 2: 20, 3: 30, 4: 40, 5: 50, 6: 60, 7: 70, 8: 80 }, // ✅ expanded for Q6
